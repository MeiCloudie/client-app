...
const ChangePasswordForm = () => {
  ...
  const validationSchema = Yup.object({
    ...
    newPassword: Yup.string()
      .notOneOf(
        [Yup.ref("password")],
        "New password and Password are the same!"
      )
      .required(),
    confirmPassword: Yup.string()
      .oneOf([Yup.ref("newPassword")], "New password must be match ")
      .required(),
  });
  return (
    <Formik
            ...
            {!isSuccess && (
              ...
              >
                <Alert onClose={handleClose} severity="warning">
                  ...
                  The current password is incorrect or the new password is not
                  in the correct format. <strong>Please re-enter!</strong>
                </Alert>
              </Snackbar>
            )}
