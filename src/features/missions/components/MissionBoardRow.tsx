import { Avatar, Box, Card, CardActions, CardContent, CardHeader, Collapse, Grid, IconButton, IconButtonProps, Typography, styled } from "@mui/material";
...
const MissionBoardRow = ({ missionList, rowType }: MissionBoardRowProps) => {
    ...
    return (
        <Grid item xs={3}>
            ...
            >
                {states[rowType]}: {missionList.filter((m) => m.state === rowType).length}/
                {missionList.length}
            </Typography>
            <Box
                sx={{
